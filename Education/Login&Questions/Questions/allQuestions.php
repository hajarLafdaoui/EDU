...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/Education/Login&Questions/Questions/QuestionCss.css">
...
<body>
    ...
    <div class='body'>
        ...
        <div class="side">
            <ul class='firstList'> 
                <li>
                    <img class='marginRight' src="http://localhost/Education/Login&Questions/Icons/home.png" alt="" width='15px'>
                    <a href='http://localhost/Education/Html/index.php'>Home</a>
                </li>
                <li class='dropIcon'>
                    <img src="http://localhost/Education/Login&Questions/Icons/questions.png" alt="" width='18px' height='20px'>
                    <div class="dropdown">       
